pub(in crate::application::routes) mod account;
pub(in crate::application::routes) mod backup;
pub(in crate::application::routes) mod bags;
pub(in crate::application::routes) mod brews;
pub(in crate::application::routes) mod cafes;
pub(in crate::application::routes) mod checkin;
pub(in crate::application::routes) mod cups;
pub(in crate::application::routes) mod gear;
mod macros;
pub(in crate::application::routes) mod roasters;
pub(in crate::application::routes) mod roasts;
pub(in crate::application::routes) mod scan;
pub(in crate::application::routes) mod tokens;
pub(in crate::application::routes) mod webauthn;
